...
const heroImages = [
  ...
  {
    src: "https://images.pexels.com/photos/34001135/pexels-photo-34001135.jpeg",
    alt: "Neon streaks",
  },
];
...
const games = [
  {
    ...
    image:
      "https://images.pexels.com/photos/33661602/pexels-photo-33661602.jpeg",
  },
  {
    id: 2,
    title: "Aetherfall Legends",
    category: "RPG" as Category,
    image:
      "https://images.pexels.com/photos/33372452/pexels-photo-33372452.png",
  },
  {
    id: 3,
    title: "Voidfront Siege",
    category: "FPS" as Category,
    image:
  ...
  },
  {
    id: 4,
    title: "Cosmic Drop",
    category: "Battle Royale" as Category,
    image: "https://images.pexels.com/photos/7233194/pexels-photo-7233194.jpeg",
  },
  {
    id: 5,
    title: "Synthwave Skirmish",
    category: "FPS" as Category,
    image: "https://images.pexels.com/photos/7787753/pexels-photo-7787753.jpeg",
  },
  {
    id: 6,
    title: "Chrono Realms",
    ...
    <section className="container py-12 md:py-16">
      ...
      <div className="mb-8 flex items-end justify-between gap-4">
        <div>
          ...
          <p className="text-foreground/70">
            Browse by category and find your next obsession.
          </p>
        </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {filtered.map((g) => (
          <div
            key={g.id}
            className="group relative rounded-2xl overflow-hidden border border-border/60 bg-secondary/40 backdrop-blur-md transition-transform hover:-translate-y-1 hover:shadow-neon"
          >
            <img
              src={g.image}
              alt={g.title}
            ...
            <div className="p-4">
              <div className="flex items-center justify-between">
                ...
                <span className="px-2 py-1 text-xs rounded-md bg-accent/15 text-accent">
                  NEON
                </span>
              </div>
              <div className="mt-4 flex items-center gap-2">
                <Button
                  ...
                  onClick={() => {
                    ...
                    toast.success(
                      `+75 MMR • Rank: ${profile?.rankTier ?? "Rookie"}`,
                    );
                  }}
