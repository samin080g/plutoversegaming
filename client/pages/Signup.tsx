      ...
      <div className="rounded-2xl border border-border/60 bg-secondary/40 backdrop-blur-md p-6">
        <div className="grid gap-4">
          <div>
            ...
            <input type="text" className="mt-1 w-full rounded-md border border-border bg-background/60 px-3 py-2 outline-none focus:ring-2 focus:ring-accent" />
          </div>
          <div>
          ...
          <Button className="bg-primary hover:bg-primary/90 shadow-neon h-11">Sign Up</Button>
        </div>
      </div>
    </section>
  );
