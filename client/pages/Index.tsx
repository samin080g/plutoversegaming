      ...
      <div className="container grid lg:grid-cols-2 gap-8 py-16 lg:py-24 items-center">
        <div className="space-y-6">
          <h1 className="font-display text-4xl md:text-6xl leading-tight tracking-wider">
            <span className="block bg-gradient-to-r from-fuchsia-400 via-cyan-300 to-fuchsia-400 bg-[length:200%_100%] bg-clip-text text-transparent animate-shine">
              Welcome to
            </span>
            <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 via-purple-400 to-cyan-400 drop-shadow-[0_0_20px_rgba(167,82,246,0.6)] animate-glow">
              Pluto Verse Gaming
            </span>
          </h1>
          <p className="text-foreground/80 text-lg md:text-xl max-w-xl">
            Enter the neon frontier. Discover cutting‑edge games, join elite
            tournaments, and rise through the leaderboard in a community built
            for the future of play.
          </p>
          <div className="flex flex-wrap gap-4">
            <NavLink to="/games">
              <Button className="bg-primary hover:bg-primary/90 shadow-neon px-6 h-12 text-base">
                Explore Games
              </Button>
            </NavLink>
            <NavLink to="/tournaments">
              <Button
                variant="outline"
                className="border-accent text-accent hover:bg-accent/10 h-12 px-6 text-base"
              >
                Tournaments
              </Button>
            </NavLink>
