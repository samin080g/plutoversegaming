  ...
  return (
    <section className="container py-12 md:py-16">
      ...
      <p className="text-foreground/70 mb-6 max-w-2xl">
        Follow live brackets and join upcoming events. Compete, climb, and claim
        glory.
      </p>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {trending.map((t, i) => (
          <div
            key={i}
            className="rounded-2xl border border-border/60 bg-secondary/40 backdrop-blur-md overflow-hidden"
          >
            <img
              src={t.image}
              alt={t.title}
